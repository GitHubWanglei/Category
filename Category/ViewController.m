...
- (void)viewDidLoad {
    ...
    NSString *str = @"好感[face]和欧文[face]和购[image1]物和欧[face]冠和[image1]维护工[face]额外";
    ...
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(10, 200, self.view.bounds.size.width-20, 300)];
...
//                                             replaceRange:NSMakeRange(3, 2)];
    label.attributedText = [str attributedStringWithPattern:@"\\[[a-zA-Z0-9\\u4e00-\\u9fa5]+\\]" imageNames:@[@"[face]", @"[image1]"]];
